...
"$dotnetpath" restore "../YouTalk.sln" -p:Configuration=$releaseconf ${@:2}
checkerror $? "Failed to download packages"

# Build
echo Building...
"$dotnetpath" build "../YouTalk.sln" -p:Configuration=$releaseconf ${@:2}
checkerror $? "Failed to build YouTalk"
